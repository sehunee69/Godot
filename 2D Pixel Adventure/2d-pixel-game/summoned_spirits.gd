...
func _ready():
	...
	if sf.has_animation("appearing"):
		sf.set_animation_loop("appearing", false)
		sf.set_animation_speed("appearing", 6.0)
	...
	play_animation("appearing")   # ← appear first, then chase
...
func _physics_process(delta):
	...
	if current_animation == "appearing":
...
func _on_animation_finished():
	...
	if anim == "appearing":
		play_animation("idle")   # start chasing after appearing
